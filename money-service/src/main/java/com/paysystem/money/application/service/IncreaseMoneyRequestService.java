package com.paysystem.money.application.service;

import com.paysystem.common.CountDownLatchManager;
import com.paysystem.common.RechargingMoneyTask;
import com.paysystem.common.SubTask;
...
import com.paysystem.money.application.port.outbound.GetMembershipPort;
import com.paysystem.money.application.port.outbound.IncreaseMoneyPort;
import com.paysystem.money.application.port.outbound.SendRechargingMoneyTaskPort;
...
public class IncreaseMoneyRequestService implements IncreaseMoneyRequestUseCase, CreateMemberMoneyUseCase {
    ...
    public MoneyChangingRequest increaseMoneyRequest(IncreaseMoneyRequestCommand command) {
        ...
        // 5. 펌뱅킹을 수행하고 (고객의 연동된 계좌 -> 페이시스템 법인 계좌) (뱅킹)
