package com.paysystem.money.adapter.axon.saga;

import com.paysystem.common.event.CheckRegisteredBankAccountCommand;
import com.paysystem.common.event.CheckedRegisteredBankAccountEvent;
...
import com.paysystem.money.application.port.outbound.IncreaseMoneyPort;
...
public class MoneyRechargeSaga {
    ...
    public void handle(CheckedRegisteredBankAccountEvent event) {
        ...
        // 송금 요청
        // 고객 계좌 -> 법인 계좌
        commandGateway.send(new com.paysystem.common.event.RequestFirmbankingCommand(
    ...
    public void handle(RequestFirmbankingFinishedEvent event, IncreaseMoneyPort increaseMoneyPort) {
        ...
        if (resultEntity == null) {
            ...
            commandGateway.send(new com.paysystem.common.event.RollbackFirmbankingRequestCommand(
